<template>
    <nav class="bg-zinc-900 pt-12 ">
        <div >
            <img class="h-80 w-[90%] mx-auto" src="../assets/img/Group 2.png" alt="">
            
        <div
         class=" bg-zinc-900 h-40 w-[80%] p-6 top-96 rounded-2xl shadow-xl mx-auto left-28    absolute ">
